...
export class RutaActualizarViajeComponent implements OnInit {
  ...
  viaje:ViajeInterface={
    id:0,ciudad_origen:"",ciudad_destino:"",fecha:"",hora:"",precio:0,cooperativa:0,total_asientos:0
  }
            ...
            return this.viajeService.buscarViaje(+queryParams['idViaje']).subscribe(
              {
                next: (datos:ViajeInterface) => {
                  ...
                  this.formActualizarViaje.get('fecha')?.setValue(datos.fecha)
                  this.formActualizarViaje.get('hora')?.setValue(datos.hora)
